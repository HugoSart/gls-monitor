...
@Component({
  selector: 'ngx-device-card-back',
  styleUrls: ['./device-card-back.component.scss'],
  templateUrl: './device-card-back.component.html',
})
export class DeviceCardBackComponent implements OnDestroy {
  private alive = true;
